...
@Component({
    selector: 'fema-cms-feedback-modal-delete-question',
    templateUrl: './feedback-modal-delete-question.component.html',
})
export class FeedbackModalDeleteQuestionComponent {
